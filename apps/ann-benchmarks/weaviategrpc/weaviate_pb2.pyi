...
class SearchRequest(_message.Message):
    ...
    def __init__(self, className: _Optional[str] = ..., limit: _Optional[int] = ..., nearVector: _Optional[_Union[NearVectorParams, _Mapping]] = ..., nearObject: _Optional[_Union[NearObjectParams, _Mapping]] = ...) -> None: ...
